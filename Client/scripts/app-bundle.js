...
define('factories/MonsterFactory',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../domain/Monster"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, Monster_1) {
    "use strict";
    var MonsterFactory = (function () {
        function MonsterFactory(eventAggregator) {
            this.eventAggregator = eventAggregator;
        }
        MonsterFactory.prototype.cloneMonster = function (monster) {
            return Object.assign(this.buildMonster(monster.name), monster);
        };
        MonsterFactory.prototype.buildMonster = function (name) {
        ...
        function BattleStack(eventAggregator, monsterFactory, combat) {
            ...
            this.eventAggregator.subscribe(messages_1.TemplateSpawned, function (msg) {
                msg.template.monsters.forEach(function (monster) {
                    _this.stack.push(monsterFactory.cloneMonster(monster));
                });
            });
            this.eventAggregator.subscribe(messages_1.MonsterKilled, function (msg) {
...
define('domain/Stores/TemplateStore',["require", "exports", "aurelia-framework", "../MonsterTemplate", "../../factories/MonsterFactory"], function (require, exports, aurelia_framework_1, MonsterTemplate_1, MonsterFactory_1) {
    "use strict";
...
define('components/monster-manager',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../domain/Stores/TemplateStore", "../factories/MonsterFactory", "../domain/MonsterTemplate"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, TemplateStore_1, MonsterFactory_1, MonsterTemplate_1) {
    "use strict";
    var MonsterManager = (function () {
        function MonsterManager(eventAggregator, templateStore, monsterFactory) {
            this.eventAggregator = eventAggregator;
            this.templateStore = templateStore;
            this.monsterFactory = monsterFactory;
