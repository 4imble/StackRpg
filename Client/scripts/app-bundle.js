...
define('domain/Gold',["require", "exports", "./Loot", "../helpers/Dice"], function (require, exports, Loot_1, Dice_1) {
    ...
    var Gold = (function (_super) {
        ...
        Gold.prototype.showToolTip = function () { alert("Showing " + this.displayName + "."); };
        ;
        Gold.prototype.moveToInventory = function () { };
        ;
...
define('domain/Weapon',["require", "exports", "./Loot", "../helpers/Dice"], function (require, exports, Loot_1, Dice_1) {
    ...
    var Weapon = (function (_super) {
        ...
        Weapon.prototype.showToolTip = function () { alert("Showing " + this.displayName); };
        ;
        Weapon.prototype.moveToInventory = function () { };
        ;
    ...
    var LootStack = (function () {
        function LootStack(eventAggregator) {
            ...
            this.eventAggregator.subscribe(messages_1.MonsterKilled, function () {
                _this.stack.push(new Gold_1.default());
                _this.stack.push(new Weapon_1.default("Thunderfury, Blessed Blade of the Windseeker"));
            });
        }
